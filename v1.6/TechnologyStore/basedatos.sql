...
INSERT INTO `usuario`(`cedulaU`,`TipoU`, `nombre`, `apellido`, `usuario`, `password`, `correo`, `direccion`, `ciudad`, `genero`, `F_nacimiento`) VALUES ('1014284949','user','andres felipe','zuleta','andru9365','12345','andru9365@gmail.com','cll 75 n 85-49','bogota','masculino','1996/10/07');
