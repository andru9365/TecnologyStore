    ...
    <body>
        ...
        <nav class="NavBar full">
            <div class="row">
                ...
                <ul class="NavBar-links col m9">
                    ...
                    <li><a href="perfil.php" class="waves-effect" >SESIÓN</a></li>
        ...
        <section>
            ...
            if ($total != 0) {
                 ...
                 echo '<center><a href="./compras/compras.php" style="font-size: 25px" class="aceptar">Comprar</a></center>;';
            }
            ?>
            <center><a href="productos.php" style="font-size: 25px;">Añadir Producto</a></center>
