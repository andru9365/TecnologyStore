...
<html lang="es">
    ...
    <body>
        ...
        <form action="validar.php" method="POST" id="LoginModal" class="modal modal-fixed-footer">
        ...
        <form action="Funcion.php" method="POST" id="RegModal" class="modal modal-fixed-footer" >
            <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="zmdi zmdi-account-box prefix"></i>
                        <input id="correo" name="corr" type="text" class="validate"required>
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 l4">
                        <div class="card hoverable">
                            ...
                            <div class="card-content">
                                <p>
                                    Phone con iOS 10EarPods con conector LightningAdaptador de Lightning a jack de 3.5 mm para audífonosCable de 
                                </p>
                            </div>
                            <div class="card-action">
                                <a href="#!">This is a link</a>
